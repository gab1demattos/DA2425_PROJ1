...
public:
    ...
    Edge<T> * addEdge(Vertex<T> *d, int driving, int walking);
 ...
 */
template <class T>
Edge<T> * Vertex<T>::addEdge(Vertex<T> *d, int walking, int driving) {
...
template <class T>
void Vertex<T>::setLocation(string location) {
    this->location = location;
}

template<class T>
void Vertex<T>::setCode(string code) {
    this->code = code;
}
...
template<class T>
bool Vertex<T>::isParkingAvailable() const {
    return this->parking;
}

template<class T>
string Vertex<T>::getLocation() const {
